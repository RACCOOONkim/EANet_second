...
def vis_3d_skeleton(kpt_3d, kpt_3d_vis, kps_lines, filename=None):
    ...
    # Instead of saving the plot, convert it to an image

def vis_3d_skeleton_to_image(kpt_3d, kpt_3d_vis, kps_lines, filename=None):
    ...
    skeleton_image = np.frombuffer(fig.canvas.tostring_rgb(), dtype=np.uint8)
    skeleton_image = skeleton_image.reshape((height, width, 3))
